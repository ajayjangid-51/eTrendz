	...
	return (
		<Fragment>
			{loading ? (
				...
				<Fragment>
					<MetaData title={`${product.name} -- Etrendz`} />
						...
						<div>
							...
							<div className="detailsBlock-3">
								...
								>
									...
									<strong>
										<span id="product_info_price_price">{product.price}</span>
										<span id="product_info_price_actualprice">
											{/* ₹<s>{person.actualprice}</s> */}₹<del>{4990}</del>
										</span>
										<small style={{ color: "var(--rd)" }}>
											Save ₹1,150 (77%)
										</small>
									</strong>
								</div>
